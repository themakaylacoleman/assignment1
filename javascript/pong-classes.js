...
export class Game {
  constructor(
    ...
    this.size = { x: 720, y: 600 }; //container for entire game
...
export class Ball {
  constructor(
    ...
    this.size = { x: 35, y: 35 }; // default ball size
    ...
    this.initial = { x: 5, y: 0 }; //speed reset on point score (increased starting speed)
    this.maximum = { x: 1000, y: 500 }; //very high maximum speed (allows unlimited growth, prevents tunneling)
...
export class Paddle {
  constructor(
    ...
    this.size = { x: 10, y: 90 }; //default paddle size
